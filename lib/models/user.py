class User:
    ...
    def height_ft(self, new_height_ft):
        if isinstance(new_height_ft, int) and 0 <= new_height_ft <= 10:
            self._height_ft = new_height_ft
        else:
            raise Exception("Height must be an integer between 0 and 10 feet.")
    ...
    def height_inches(self, new_height_inches):
        if isinstance(new_height_inches, int) and 0 <= new_height_inches < 12:
            self._height_inches = new_height_inches
        else:
            raise Exception("Height inches must be an integer between 0 and 11 inches.")
    ...
    def weight(self, new_weight):
        if isinstance(new_weight, (float, int)) and new_weight > 0:
            self._weight = new_weight
        else:
            raise Exception("Weight must be a positive float or integer.")
    ...
    def add_height(self, new_height_ft, new_height_inches):
        ...
        if not (0 <= new_height_ft <= 10) or not (0 <= new_height_inches < 12):
    ...
    def add_weight(self, new_weight):
        ...
        if not isinstance(new_weight, (float, int)) or new_weight <= 0:
            raise ValueError("Weight must be a positive float or integer.")
