...
class Exercise:
    ...
    def name(self, name):
        if isinstance(name, str) and 0 < len(name) <= 20:
            ...
            raise Exception("\033[31m Invalid name. Name must be a string greater than 0 and less than 20 characters.\033[0m")
    @property
    def time(self):
        return self._time
    @time.setter
    def time(self, time):
        ...
        if isinstance(time, int) and 0 < time:
            ...
            raise Exception("\033[31m Invalid duration. Duration must be a number greater than 0.\033[0m")
    ...
    def category(self, category):
        if category in Exercise.CATEGORY:
            ...
            raise Exception("\033[31m Invalid category. Please select between Cardio or Strength.\033[0m")
    @property
    def intensity(self):
    ...
    def intensity(self, intensity):
        if intensity in Exercise.INTENSITY:
            ...
            raise Exception("\033[31m Invalid intensity. Please select either Beginner, Intermediate, Advanced.\033[0m")
    @property
    ...
    def cals_burned(self, cals_burned):
        ...
        if isinstance(cals_burned, int) and 0 < cals_burned:
            ...
            raise Exception("\033[31m Invalid calories. Calories must be a number greater than 0.\033[0m")
    @classmethod
    ...
    def most_popular(cls):
        ...
        print("\033[36m Most popular exercises:\033[0m")
        for exercise in most_used_list:
            print(f"\033[32m- {exercise.name} completed {num_time} times!\033[0m")
    ...
    def least_popular(cls):
        ...
        print("\033[36m Least popular exercises:\033[0m")
        for exercise in least_used_list:
            print(f"\033[32m- {exercise.name} completed only {num_time} times!\033[0m")