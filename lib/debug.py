...
def reset_database():
    ...
    Log.create("John Doe", treadmill, "2023-09-28")
    Log.create("Alice Smith", weights, "2023-09-28")
    Log.create("Bob Johnson", walking, "2023-09-27")
    Log.create("Eve Adams", jump_rope, "2023-09-27")
